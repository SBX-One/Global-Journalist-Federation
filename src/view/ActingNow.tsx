    ...
    return (
        <div className="px-5 jdm:px-10">
            <div className="font-bold pb-9.25">
                <h1 className="text-[25px] jdm:text-[45px] text-center text-journalist-gray-100">GET INFORMED GET FREEDOM</h1>
                <h1 className="text-journalist-red-error text-[30px] relative jdm:bottom-8 jdm:text-[40px] text-center">ACTING NOW AND TOGETHER</h1>
            </div>
