    ...
    return (
        <div ref={container} className="overflow-hidden jdm:px-10">
            ...
            <div className="px-5 flex flex-col gap-4 mt-10">
                ...
                <h1 className="hero-text font-medium text-2xl jdm:text-journalist-size jdm:max-w-81 jdm:text-right jdm:ml-auto jdm:relative jdm:bottom-14 text-black/30">Global Journalist Federation</h1>
            </div>
